...
Write-Host '  4. node scripts\daily-attendance-whatsapp.mjs --list-groups'
Write-Host '     (scan QR with the phone that is IN the group "Malcon life sciences")'
Write-Host '  5. Copy the group ID into .env as ATTENDANCE_WHATSAPP_GROUP_ID=...'
Write-Host '  6. node scripts\daily-attendance-whatsapp.mjs'
Write-Host '  7. Check the group on your phone — image should appear'
Write-Host ''
