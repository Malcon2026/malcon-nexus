...
export const DASHBOARD_NOTE_COLORS: {
  ...
  { id: 'default', card: 'bg-white border-gray-100', dot: 'bg-white border border-gray-300' },
  { id: 'yellow', card: 'bg-amber-50 border-amber-100', dot: 'bg-amber-300' },
  { id: 'green', card: 'bg-emerald-50 border-emerald-100', dot: 'bg-emerald-400' },
  { id: 'blue', card: 'bg-sky-50 border-sky-100', dot: 'bg-sky-400' },
  { id: 'pink', card: 'bg-pink-50 border-pink-100', dot: 'bg-pink-400' },
  { id: 'purple', card: 'bg-violet-50 border-violet-100', dot: 'bg-violet-400' },
  { id: 'orange', card: 'bg-orange-50 border-orange-100', dot: 'bg-orange-400' },
  { id: 'gray', card: 'bg-gray-50 border-gray-200', dot: 'bg-gray-400' },
];
