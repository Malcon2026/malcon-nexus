  ...
  return (
    <div className="p-4 sm:p-6 max-w-[1200px] mx-auto w-full min-w-0 space-y-5">
      ...
      <p className="text-sm text-gray-600">
        View only — {savedCount} of {rows.length} employees submitted for this day. Meals are chosen in the employee
        app (Submit once).
      </p>
          ...
          <table className="w-full text-sm min-w-[520px]">
            ...
            <tbody className="divide-y divide-gray-100">
              {rows.map(({ employee, selection }) => {
                ...
                const statusLabel = saved ? 'Submitted' : 'Pending';
