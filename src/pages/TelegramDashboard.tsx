...
export const TelegramDashboard: React.FC = () => {
  ...
  return (
    <NexusPage maxWidthClass="max-w-[1100px]">
      <NexusPageHeader
        title="Telegram Dashboard"
        description={`${connected.length} connected · ${notConnected.length} not connected`}
      />
          ...
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
            ...
            <div className="flex flex-wrap gap-2">
              <button
                ...
                className={`px-2.5 py-1 text-xs rounded-full ${filter === 'all' ? 'bg-[var(--color-accent)] text-white' : 'bg-gray-100 text-gray-600'}`}
              >
                All
              </button>
              <button
                ...
                className={`px-2.5 py-1 text-xs rounded-full ${filter === 'connected' ? 'bg-[var(--color-accent)] text-white' : 'bg-gray-100 text-gray-600'}`}
              >
                Connected
              </button>
              <button
                ...
                className={`px-2.5 py-1 text-xs rounded-full ${filter === 'not-connected' ? 'bg-[var(--color-accent)] text-white' : 'bg-gray-100 text-gray-600'}`}
              >
                Not connected
              </button>
